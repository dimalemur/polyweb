  ...
  return (
    <div className={classes.root}>
      ...
      >
        ...
        <Divider />
        <List>
          <Mainlistitems admin='admin' selectedIndex={selectedIndex} />
        </List>
        <Divider />
        ...
        <Container maxWidth='lg' className={classes.container}>
          <Box pt={4}>
            <Route
              ...
              component={() => <Gruops setSelectedIndex={setSelectedIndex} />}
            />
            <Route
            ...
            <Route
              ...
              component={() => <Addinfo setSelectedIndex={setSelectedIndex} />}
            />
          </Box>
        </Container>
      </main>
